...
public class RentalStartedConsumer {
    ...
    public void approved(RentalStartedEvent event) {
    ...
    private void sendStartedEmail(
        ...
        mail.setSubject("Location démarrée ✅");
        ...
        mail.setText(
                "Bonjour " + renter.getFullName() + ",\n\n" +
                        ...
                        "Votre demande de location a démarrée pour l'item suivant :\n\n" +
